 ...
 * <br>
 * <br>
 * If {@link HttpHeaders#AUTHORIZATION} is present, user ID is extracted from existing JWT. If the header is invalid
 * or missing entirely, {@link HttpHeaders#USER_ID} is used instead.
 */
@Component
